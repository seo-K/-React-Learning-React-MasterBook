...
var btnDecrease = document.querySelector("#decrease"); // 1. action ( 액션 )

var TOGGLE_SWITCH = "TOGGLE_SWITCH";
var INCREASE = "INCREASE";
var DECREASE = "DECREASE"; // 2. action creator ( 액션 생성 함수 )
...
console.log(state, "누구야"); // 4. store ( 스토어 )

var store = (0, _redux.legacy_createStore)(reducer); // 4-1. render (스토어 내장 함수 랜더)
...
render(); // 6. subscribe ( 구독 )

store.subscribe(render); // 5. dispatch ( 디스패치 ) -> 액션 발생
...
},{"redux":"node_modules/redux/es/redux.js"}],"C:/Users/dkasi/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["C:/Users/dkasi/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","index.js"], null)
